...
comet::HostObservation HostdObservedStateSnapshotBuilder::BuildObservedStateSnapshot(
  ...
  observation.gpu_telemetry_json = comet::SerializeGpuTelemetryJson(
      system_telemetry_collector_.CollectGpuTelemetry(
          telemetry_state,
          node_name,
          instance_statuses));
  comet::DiskTelemetrySnapshot disk_snapshot;
  ...
  observation.disk_telemetry_json = comet::SerializeDiskTelemetryJson(disk_snapshot);
  observation.network_telemetry_json = comet::SerializeNetworkTelemetryJson(
      system_telemetry_collector_.CollectNetworkTelemetry());
  observation.cpu_telemetry_json = comet::SerializeCpuTelemetryJson(
